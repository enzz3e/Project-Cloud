                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="nama"
                                    ...
                                    value="{{ old('nama') }}" placeholder="Masukkan Nama Ruangan...">
                                @error('nama')
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select id="lantai" name="lantai"
                                    ...
                                    <option value="Lantai 1" {{ old('lantai') == 'Lantai 1' ? 'selected' : '' }}>Lantai 1
                                    </option>
                                    <option value="Lantai 2" {{ old('lantai') == 'Lantai 2' ? 'selected' : '' }}>Lantai 2
                                    </option>
                                    <option value="Lantai 3" {{ old('lantai') == 'Lantai 3' ? 'selected' : '' }}>Lantai 3
                                    </option>
                                </select>
                                @error('lantai')
                                    <div class="text-danger"><small>{{ $message }}</small></div>
